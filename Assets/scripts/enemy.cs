...
public class Enemy : MonoBehaviour
{
    ...
    public int enemyMovementPoints = 3;
    public int enemyAttackRange = 1;
    public float damageAmount = 10f; // Damage dealt by the enemy
    ...
    {
        // Set the current enemy's turn points to zero
        currentEnemyMovementPoints = 0;
